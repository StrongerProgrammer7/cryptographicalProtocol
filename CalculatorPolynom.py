...
class CalculatorPolynomGalua(MyMath):
    ...
    def divmodPolynoms(self, polynom1, polynom2):
        ...
        while True:
            ...
            if factor > -1:
                ...
                polynom = self._fromBinaryArrayToDegree(self.xorPolynoms(polynom1, polynom))
                r = polynom
                div.append(factor)
                polynom1 = polynom
            else:
    ...
    def xorPolynoms(self, polynom1, polynom2):
        ...
        return self._xorPolynoms(polynom1, polynom2)
    ...
    def _addZeroToBegin(self,polynom,max_length):
